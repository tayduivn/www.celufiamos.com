 ...
 * @since 1.5.0
 */
class FunpaysiteValidationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        $this->module->validateOrder(
            (int)$cart->id,
            Configuration::get(strtoupper($this->module->name.'_state')),
            $total,
