        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<div class="container">
					<p class="title1">Amazing iPhone</p>
					<p class="title2">Amazing price</p>
					<p class="title3">Enjoy up to <span>RM300</span> savings & additional 1 year warranty when you get <span>iPhone X<span> or <span>iPhone 8</span></span></span></p>
					...
					<div class="container">
					<p class="title1">Kz-<span>es3</span></p>
					<p class="title2">Bluetooth<span>Headphone</span></p>
					<p class="title3">get up to<span>$199</span></p>
					<p class="readmore"><a href="#"><span>Shop now</span></a></p>
					</div>
					</div>';
				}
