...
<div class="page-my-account">
	<div id="content">
	    ...
	    <div id="" class="links">
	      ...
	      {/if}
	      <a class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="identity-link" href="{$url_saldo}">
	        <span class="link-item">
	          <i class="material-icons">money_off</i>
	          {l s='Saldo disponible' d='Moodules.ps_kaiowa.myaccount'}
	        </span>
	      </a>
			<a class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="identity-link" href="{$url_contact}">
	        <span class="link-item">
