...
{block name='page_title'}
  {l s='Estado de cuenta' d='Shop.Theme.Customeraccount'}
{/block}
		  ...
		  <table class="table">
		    ...
		    {foreach from=$status item=credit}
		      <tr>
		        ...
		        <th scope="col"><button data-toggle="modal" data-target="#infoModal" id="{$credit->id_obligacion}" type="button" class="btn btn-info view-credit">{l s='Ver detalle' d='Modules.ps_kaiowa.myaccount'}</button></th>
		      </tr>
		    {/foreach}  
		    </tbody>
		  </table>
