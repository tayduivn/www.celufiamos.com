...
{if $status == 'ok'}
    <p>
      {l s='Su pedido %s está completo.' sprintf=[$shop_name] d='Modules.Wirepayment.Shop'}<br/>
      {l s='Por favor realice su pago por Corresponsales Bancarios Bancolombia.' d='Modules.Wirepayment.Shop'}
    </p>
