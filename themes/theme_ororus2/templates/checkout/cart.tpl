    ...
    <div class="cart-grid row">
      ...
      <div class="cart-grid-body col-xs-12 col-lg-8">
        ...
        {block name='continue_shopping'}
          <div class="product-note">{l s='Solo puedes hacer una compra por proceso debes eliminar el producto seleccionado para cambiar a otro producto de tu preferencia' d='Shop.Theme.Actions'}</div>
