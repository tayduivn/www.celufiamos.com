        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<div class="container">
					<p class="title1">Saturn</p>
					<p class="title2">CCtv camera</p>
					<p class="title3">Industry-leading image quality and video stram in all conditions</p>
					...
					<p class="title2">Wireless Bluetooth <span>Headphone</span></p>
