...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9f9eQJoaEJ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2zB-faIEY7', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'c3luf14m_prestashop', 'user' => 'c3luf14m_prestashop', 'password' => 'GPKK5DaNxj1E', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_9b787c7d7cb1c62f398de8732bc9bd76cfd8b23bfbfd514f0893da000229f259');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rmUDnj+u8j', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Gci-UmDfbh', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('foLKmvcn4w', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('UQYICsSiQzBiAWXOXAgAJQSsFDHsBDa8IYy7M88DF6TP4n2v9uI2hro8');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                61 => 'posstaticblocks',
                62 => 'posstaticfooter',
                63 => 'posfeaturedproducts',
                64 => 'poslistcategories',
                65 => 'possearchproducts',
                66 => 'posspecialproducts',
                67 => 'poscountdown',
                68 => 'xipblog',
                69 => 'xipblogdisplayposts',
                70 => 'posnewproducts',
                71 => 'poslistcateproduct',
                72 => 'postabproductslider',
                73 => 'postabcateslider',
                74 => 'postestimonials',
                75 => 'ps_cashondelivery',
                76 => 'rkrregistroampliado',
                77 => 'ps_kaiowa',
                78 => 'ps_wirepayment',
                79 => 'adminmenu',
            ],
            ...
            'database_port' => '',
            'database_name' => 'c3luf14m_prestashop',
            'database_user' => 'c3luf14m_prestashop',
            'database_password' => 'GPKK5DaNxj1E',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'UQYICsSiQzBiAWXOXAgAJQSsFDHsBDa8IYy7M88DF6TP4n2v9uI2hro8',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-06-18',
            'locale' => 'es-ES',
            'cookie_key' => '5SU5qw41Bmmo6X6H1yDTfEBv4e9So2t3OoLe58ZFzoh7R84b2OpHbdfC',
            'cookie_iv' => 'N5hGD7ai',
            'new_cookie_key' => 'def00000b5c1888c825f922bc9cee57637619e3cb842a9c71e26f54d54872718eb2569b1049c58037569d11a8c6c4bd949dd09ba5ad80981d34bf3310c29225b97892a4c',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'UQYICsSiQzBiAWXOXAgAJQSsFDHsBDa8IYy7M88DF6TP4n2v9uI2hro8',
