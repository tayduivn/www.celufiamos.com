...
class __TwigTemplate_85ad15cb5bcce317b065db11f55af517910b2d76d80e1ea64d75b6fcbcd6c16c extends Twig_Template
{
...
";
    ...
    <p>
      ...
      ";
        // line 30
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Discover the best-selling modules of this category in the %link% page.", array("%link%" => (((("<a href=\"" . $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_module_catalog", array("filterCategoryRef" => $this->getAttribute(($context["category"] ?? null), "refMenu", array())))) . "\">") . $this->getAttribute(($context["category"] ?? null), "name", array())) . "</a>")), "Admin.Modules.Feature");
        echo "
    </p>
  </div>
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/grid_manage_empty.html.twig", "/home/c3luf14m0s/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/grid_manage_empty.html.twig");
    }
}
